...
constraints:
  ...
  - "2026 tax year brackets and AMT exemptions apply; OBBBA (July 4, 2025) permanently extended higher AMT exemptions but reverted phaseout thresholds to $500K/$1M AND doubled the exemption phaseout rate from 25% to 50% effective 2026 — the AMT-safe window for ISO exercises is materially narrower in 2026 than 2025"
...
# === SKIP CONDITIONS ===
skip_this_unit_if:
  - condition: "User is asking about equity compensation accounting (ASC 718 / IFRS 2 stock-comp expense), not the employee's personal income tax"
    use_instead: "An accounting/financial-reporting reference on share-based payment expense — this unit covers only the individual taxpayer's federal income tax."
  - condition: "User is asking how to set the strike price / 409A valuation methodology for a private company, not how the resulting options are taxed"
    use_instead: "A 409A valuation methodology reference — this unit covers tax treatment after grant, not strike-price determination."
  - condition: "User is a non-US tax resident with zero US-source option income and needs their own country's rules"
    use_instead: "compliance/tax/permanent-establishment/2026"
  - condition: "User is asking about ESPP (IRC Section 423 Employee Stock Purchase Plan) taxation, not option taxation"
    use_instead: "An IRC 423 ESPP taxation reference — ESPPs follow different qualifying/disqualifying disposition and discount rules than ISOs/NSOs."
...
related_kos:
  ...
  related_to:
    ...
    - id: "compliance/tax/rd-tax-credits/2026"
      label: "R&D Tax Credits (another startup-stage federal tax incentive)"
    - id: "compliance/tax/permanent-establishment/2026"
      label: "Permanent Establishment (cross-border sourcing of equity-comp income)"
  often_confused_with:
    - id: "compliance/tax/permanent-establishment/2026"
      label: "Permanent Establishment — also a cross-border tax rule, but governs corporate taxable presence, not individual equity-comp income sourcing"
    - id: "compliance/tax/rd-tax-credits/2026"
      label: "R&D Tax Credits — also a federal tax rule for startups, but a corporate credit unrelated to employee equity taxation"
  solves: []
  alternative_to: []
...
sources:
  ...
  - id: src8
    ...
    reliability: authoritative
  - id: src9
    title: "The Return of AMT: What High Earners Need to Know in 2026"
    author: Wealthspire Advisors
    url: https://www.wealthspire.com/blog/the-return-of-alternative-minimum-tax-amt-what-high-earners-need-to-understand-about-2026/
    type: industry_report
