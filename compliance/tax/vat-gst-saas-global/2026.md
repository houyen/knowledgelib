...
constraints:
  ...
  - "EU ViDA package (adopted 11 Mar 2025) rolls out in firm stages: OSS clarifications 1 Jan 2027, Single VAT Registration + mandatory reverse charge for non-established suppliers 1 Jul 2028, mandatory B2B e-invoicing + digital reporting 1 Jul 2030"
  - "Applies from first sale in many jurisdictions (zero threshold); some have revenue thresholds (e.g., Australia AUD 75,000, New Zealand NZD 60,000, Canada CAD 30,000)"
...
related_kos:
  ...
  related_to:
    - id: "compliance/tax/permanent-establishment/2026"
      label: "Permanent Establishment (corporate-tax nexus, distinct from VAT registration)"
    - id: "compliance/tax/transfer-pricing-basics/2026"
      label: "Transfer Pricing Basics (intra-group cross-border tax)"
    - id: "finance/saas-benchmarks/saas-gross-margin-benchmarks/2026"
      label: "SaaS Gross Margin Benchmarks (financial context for compliance-cost trade-offs)"
  often_confused_with:
    - id: "compliance/tax/us-sales-tax-nexus-saas/2026"
      label: "US Sales Tax Nexus for SaaS (state-level nexus system, NOT VAT/GST)"
  solves: []
  alternative_to: []
...
sources:
  ...
  - id: src6
    ...
    reliability: moderate_high
  - id: src7
    title: "VAT in the Digital Age (ViDA) -- official implementation timeline"
    author: European Commission (Taxation and Customs Union)
    url: https://taxation-customs.ec.europa.eu/taxation/vat/vat-digital-age-vida_en
    type: government_regulation
    published: 2026-05-22
    reliability: authoritative
  - id: src8
    title: "Azerbaijan to require VAT registration for nonresident entities providing digital services to individuals"
    author: EY Global
    url: https://www.ey.com/en_gl/technical/tax-alerts/azerbaijan-to-require-vat-registration-for-nonresident-entities-providing-digital-services-to-individuals
    type: industry_report
    published: 2026-03-05
    reliability: high
  - id: src9
    title: "Mauritius VAT Rules for Foreign Digital Services (From 2026)"
    author: Fonoa
    url: https://www.fonoa.com/resources/blog/mauritius-vat-foreign-digital-services-2026
    type: industry_report
...
- **Jurisdictions covered**: 110+ countries with VAT/GST on digital services, growing annually; 2026 additions include Mauritius (15%, zero threshold) and Azerbaijan (US$10,000 threshold) [src1, src9, src8]
- **EU VAT rates**: Range from 17% (Luxembourg) to 27% (Hungary); 14 rate changes occurred in 2025 alone [src2]
- **Registration thresholds**: Zero in most major markets (EU for non-EU sellers, India, Turkey, Saudi Arabia, UAE, Mauritius); AUD 75,000 in Australia; NZD 60,000 in New Zealand; CAD 30,000 in Canada; US$10,000 in Azerbaijan; EUR 10,000 combined cross-border for EU sellers [src1, src4, src9, src8]
- **EU ViDA milestones**: OSS/IOSS clarifications 1 Jan 2027; Single VAT Registration + mandatory reverse charge for non-established suppliers 1 Jul 2028; mandatory B2B e-invoicing + Digital Reporting Requirements 1 Jul 2030 (full alignment by 2035) [src7]
- **B2B reverse charge**: Available in most EU, UK, and OECD countries; approximately 25 countries also require B2B registration regardless (e.g., Mauritius mandates registration even when reverse charge applies) [src1, src9]
...
- ViDA's firm milestones change EU compliance mechanics: OSS clarifications (1 Jan 2027), Single VAT Registration + mandatory reverse charge for non-established suppliers (1 Jul 2028), and mandatory B2B e-invoicing + real-time Digital Reporting Requirements (1 Jul 2030) [src7, src2]
...
- [US Sales Tax Nexus for SaaS](/compliance/tax/us-sales-tax-nexus-saas/2026) -- often confused with VAT/GST; a separate state-level nexus system
- [Permanent Establishment](/compliance/tax/permanent-establishment/2026) -- corporate-tax nexus, distinct from VAT registration
- [Transfer Pricing Basics](/compliance/tax/transfer-pricing-basics/2026) -- intra-group cross-border tax considerations
- [SaaS Gross Margin Benchmarks](/finance/saas-benchmarks/saas-gross-margin-benchmarks/2026) -- financial context for weighing per-market compliance costs
