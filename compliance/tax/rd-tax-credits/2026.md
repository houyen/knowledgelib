...
temporal_validity:
  status: evolving
  last_breaking_change: 2025-11-04
...
constraints:
  ...
  - "Temporal: US restored immediate domestic R&D expensing under Section 174A via OBBBA (signed July 4, 2025; Rev. Proc. 2025-28 procedures issued Aug 28, 2025); Canada Budget 2025 raised the SR&ED enhanced limit to CAD 6M (tax years beginning on/after Dec 16, 2024); France 2026 Finance Law (adopted Feb 2, 2026) kept CIR at 30% unchanged; UK targeted Advance Assurance pilot + mandatory agent registration both start 18 May 2026"
  - "Entity threshold: US qualified small business payroll offset ($500K cap) requires <= $5M gross receipts and < 5 years old; Canada SR&ED enhanced 35% refundable rate now applies to the first CAD 6M for CCPCs (and certain eligible public corporations); UK ERIS requires 30% R&D intensity"
...
# === SKIP CONDITIONS ===
skip_this_unit_if:
  - condition: "User is asking specifically about transfer pricing for contract R&D charged between affiliates"
    use_instead: "compliance/tax/transfer-pricing-basics/2026"
  - condition: "User is asking whether R&D activity creates a taxable presence (permanent establishment) in a foreign country"
    use_instead: "compliance/tax/permanent-establishment/2026"
  - condition: "User is asking about indirect tax (VAT/GST) treatment of R&D or SaaS, not income-tax R&D credits"
...
related_kos:
  ...
  related_to:
    ...
    - id: "compliance/tax/permanent-establishment/2026"
      label: "Permanent establishment (cross-border R&D operations can create PE)"
    - id: "compliance/tax/stock-options-tax/2026"
      label: "Stock options tax (equity comp for R&D staff affects QRE wage base)"
  often_confused_with:
    - id: "compliance/tax/transfer-pricing-basics/2026"
      label: "Transfer pricing (contract R&D pricing between affiliates — a related but distinct income-tax topic)"
    - id: "compliance/tax/vat-gst-saas-global/2026"
      label: "VAT/GST on SaaS (indirect tax, not the income-tax R&D credit)"
  solves: []
  alternative_to: []
...
sources:
  ...
  - id: src8
    ...
    reliability: moderate_high
  - id: src9
    title: "IRS Issues Procedural Guidance on OBBBA Treatment of R&E Expenditures (Rev. Proc. 2025-28)"
    author: BDO
    url: https://www.bdo.com/insights/tax/irs-issues-procedural-guidance-on-obbba-treatment-of-r-and-e-expenditures
    type: industry_report
    published: 2025-09-02
    reliability: high
  - id: src10
    title: "Canada's SR&ED Program Enters a New Era: Key Impacts for Businesses (Budget 2025)"
    author: KPMG Canada
    url: https://kpmg.com/ca/en/insights/2026/02/canadas-sr-and-ed-program-enters-a-new-era.html
    type: industry_report
    published: 2026-02-01
    reliability: high
  - id: src11
    title: "R&D Tax Relief: the Merged Scheme and Enhanced R&D Intensive Support (incl. 2026 Advance Assurance pilot)"
    author: HMRC / GOV.UK
    url: https://www.gov.uk/guidance/research-and-development-rd-tax-relief-the-merged-scheme-and-enhanced-rd-intensive-support
    type: government_regulation
    published: 2026-05-01
    reliability: authoritative
  - id: src12
    title: "Loi de finances 2026 : le CIR maintenu, quels impacts ?"
    author: Zabala
    url: https://www.zabala.fr/actualites/loi-finances-2026-cir/
    type: industry_report
...
│   ├── Canada
│   │   ├── CCPC with ≤ CAD 6M QREs → 35% refundable ITC (enhanced limit raised from CAD 3M, Budget 2025) [src6, src10]
...
- [Stock Options Tax](/compliance/tax/stock-options-tax/2026)
- [VAT/GST on SaaS (Global)](/compliance/tax/vat-gst-saas-global/2026)
