...
constraints:
  ...
  - "Pillar One Amount A (EUR 20B revenue / 10% profit margin threshold) remains unratified as of May 2026 - the Multilateral Convention has not opened for signature, so it is not yet in force"
  - "State/provincial economic nexus rules (e.g., US state nexus thresholds of $100K-$1M+) operate independently of treaty PE rules"

# === SKIP CONDITIONS ===
skip_this_unit_if:
  - condition: "User is asking about US state sales-tax nexus for SaaS (not federal/treaty PE)"
    use_instead: "compliance/tax/us-sales-tax-nexus-saas/2026"
  - condition: "User is asking about VAT/GST registration thresholds for digital services"
    use_instead: "compliance/tax/vat-gst-saas-global/2026"
  - condition: "User is asking about transfer pricing profit allocation (not the PE threshold itself)"
...
related_kos:
  ...
  related_to:
    - id: "compliance/tax/transfer-pricing-basics/2026"
      label: "Transfer Pricing Basics (profit allocation once a PE exists)"
    - id: "compliance/employment/remote-work-jurisdiction-rules/2026"
      label: "Remote Work Jurisdiction Rules (where cross-border PE risk originates)"
    - id: "compliance/employment/contractor-vs-employee-global/2026"
      label: "Contractor vs Employee Global (dependent-agent PE turns on this status)"
  often_confused_with:
    - id: "compliance/tax/us-sales-tax-nexus-saas/2026"
      label: "US Sales-Tax Nexus for SaaS (sub-national economic nexus, not treaty PE)"
    - id: "compliance/tax/vat-gst-saas-global/2026"
      label: "VAT/GST on SaaS Globally (indirect-tax registration, not income-tax PE)"
  solves: []
  alternative_to: []
...
sources:
  ...
  - id: src6
    ...
    reliability: high
  - id: src7
    title: "OECD Model Commentary 2025: Key Changes at a Glance (first update since 2017)"
    author: Moore TK
    url: https://moore-tk.de/en/2026/01/19/oecd-musterkommentar-2025-wichtigste-aenderungen-im-ueberblick/
    type: industry_report
...
- [Contractor vs Employee Global](/compliance/employment/contractor-vs-employee-global/2026)
- [US Sales-Tax Nexus for SaaS](/compliance/tax/us-sales-tax-nexus-saas/2026)
- [VAT/GST on SaaS Globally](/compliance/tax/vat-gst-saas-global/2026)
