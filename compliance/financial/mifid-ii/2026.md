...
temporal_validity:
  status: evolving
  last_breaking_change: "2026-03-02"
...
# === SKIP CONDITIONS ===
skip_this_unit_if:
  - condition: "User is a US firm and needs US securities/derivatives market conduct rules (Volcker Rule, swap dealer registration)"
    use_instead: "compliance/financial/dodd-frank/2026"
  - condition: "User needs payment services or open-banking obligations (SCA, TPP licensing, account-access APIs) rather than investment-firm conduct"
    use_instead: "compliance/financial/psd2-open-banking/2026"
  - condition: "User needs anti-money-laundering / know-your-customer onboarding obligations rather than MiFID conduct rules"
...
related_kos:
  ...
  related_to:
    - id: "compliance/financial/psd2-open-banking/2026"
      label: "PSD2 / EU Open Banking — adjacent EU financial-services regime for payment services and account access"
    - id: "compliance/financial/aml-kyc-framework/2026"
      label: "AML/KYC onboarding obligations that apply alongside MiFID II investment-firm authorization"
  often_confused_with:
    - id: "compliance/financial/dodd-frank/2026"
      label: "Dodd-Frank — the US market-conduct and derivatives regime often mistaken for the EU MiFID II equivalent"
    - id: "compliance/financial/psd2-open-banking/2026"
      label: "PSD2 — separate EU regime governing payment services, not investment-firm conduct"
  solves: []
  alternative_to:
    - id: "compliance/financial/dodd-frank/2026"
      label: "Dodd-Frank — the US analog covering securities-market conduct for firms outside the EU/EEA"

# === SOURCES (7 authoritative sources with data backing the rule) ===
...
sources:
  ...
  - id: src6
    ...
    reliability: authoritative
  - id: src7
    title: "ESMA Public Statement on the Transition for the application of the MiFID II/MiFIR review – No.2"
    author: European Securities and Markets Authority
    url: https://www.esma.europa.eu/trading/mifid-ii-and-mifir-review
    type: official_docs
