...
temporal_validity:
  status: evolving
  last_breaking_change: "SEC proposed two-tier filer-status framework ($2B large-accelerated-filer threshold; 404(b) limited to large accelerated filers), May 19, 2026"
...
constraints:
  ...
  - "PCAOB AS 2201 amendments take effect for audits of fiscal years beginning on or after December 15, 2026 (postponed one year via PCAOB File No. PCAOB-2025-01) — current standards still apply until then"
  - "The SEC's May 19, 2026 filer-status proposal ($2B large-accelerated-filer threshold; two-tier framework; 404(b) limited to large accelerated filers) is a PROPOSAL in a 60-day comment period — current $75M/$700M filer thresholds and exemptions remain in force until any final rule"
...
skip_this_unit_if:
  ...
  - condition: "User is asking about EU financial / markets compliance (not US securities reporting)"
...
related_kos:
  ...
  related_to:
    - id: "compliance/financial/dodd-frank/2026"
      label: "Dodd-Frank Act Requirements (post-2008 US financial reform, overlapping SEC oversight)"
    - id: "compliance/financial/aml-kyc-framework/2026"
      label: "AML/KYC Framework (parallel financial-compliance control regime)"
  often_confused_with:
    - id: "compliance/financial/dodd-frank/2026"
      label: "Dodd-Frank (different statute — systemic-risk/consumer reform, not ICFR/audit attestation)"
    - id: "compliance/financial/mifid-ii/2026"
      label: "MiFID II (EU markets-conduct regime, not US financial-reporting controls)"
  solves: []
  alternative_to: []
...
sources:
  ...
  - id: src8
    ...
    reliability: authoritative
  - id: src9
    title: "SEC Proposes Streamlined Filer Status Categories and Increased Access to Scaled Disclosure Accommodations"
    author: Morrison Foerster
    url: https://www.mofo.com/resources/insights/260520-sec-proposes-streamlined-filer-status-categories
    type: industry_report
    published: 2026-05-20
    reliability: high
  - id: src10
    title: "Reading Between the Lines: The New SEC SOX Enforcement Group"
    author: Foley & Lardner
    url: https://www.foley.com/insights/publications/2026/03/reading-between-the-lines-the-new-sec-sox-enforcement-group/
    type: industry_report
...
- [Dodd-Frank Act Requirements](/compliance/financial/dodd-frank/2026)
- [AML/KYC Framework](/compliance/financial/aml-kyc-framework/2026)
- [MiFID II (EU markets compliance)](/compliance/financial/mifid-ii/2026)
- [GDPR Summary (data privacy, not financial reporting)](/compliance/privacy/gdpr-summary/2026)
